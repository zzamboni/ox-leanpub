#+macro: book #+html: <iframe width='160' height='400'" src='https://leanpub.com/$1/embed' frameborder='0' allowtransparency='true'></iframe></iframe>
...
{{{book(emacs-org-leanpub)}}}
{{{book(lit-config)}}}
{{{book(learning-hammerspoon)}}}
{{{book(learning-cfengine)}}}
{{{book(utilerias-unix)}}}
