...
This is controlled by the Org-mode [=H= export option](https://orgmode.org/manual/Export-Settings.html#index-org_002dexport_002dheadline_002dlevels). Its default value is 3, which causes all lower-level headlines to be exported as lists instead. To fix this, you have to increase the value of this option.
